...
public class RobotContainer {
    ...
    public RobotContainer() {
        switch (Constants.currentMode) {
            ...
            case SIM:
                ...
                pivot = new Pivot(new PivotIOSim(driveSimulation));
                break;
            default:
    ...
    private void configureButtonBindings() {
        ...
        controller.pov(0).onTrue(Commands.runOnce(() -> pivot.setIntakeState(true), pivot));

        controller.pov(0).onFalse(Commands.runOnce(() -> pivot.setIntakeState(false), pivot));
    }
